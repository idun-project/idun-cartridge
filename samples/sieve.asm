...
!ifdef TOOLBAR {
   ...
   jmp __lua_init
__idun_main_menu = *
   +toolUserIntfMenu 2, 18, __main_menu_pos, ~__main_menu_refresh, ~__main_menu_code
   lda #$80
   sta toolUserStyles
   lda #$22
   sta toolUserColor
   jsr toolUserNode
__main_menu_pos !byte 0,0
   jsr toolUserMenuItem
       !pet $20,0,"Restart        ",0
   jsr toolUserMenuItem
       !pet HotkeyStop,0,"Exit to Shell  ",0
   jsr toolUserEnd
   inc __main_menu_refresh
   rts
} else {
   jsr aceWinMax
   jsr aceWinSize
