...
; Mode 5: lores (320x256), high-color bitmap (8x2 attr, 312 line PAL)
...
.vdc_mode_preset:
   ...
   !word $4000, 0       ;double buffer bitmap addr
   !word .vdcreg_mode_2
   !byte 80,60          ;columns, rows
   !word 80*30*8, 0     ;interlace bitmap offset
   !word .vdcreg_mode_3
   !byte 40,32          ;columns, rows
   !word $2d00, $5500   ;double buffer bitmap/attr addr
   !word .vdcreg_mode_4
   !byte 80,60          ;columns, rows
   !word 80*30*8, 80*60 ;interlace bitmap/attr offset
   !word .vdcreg_mode_5
   !byte 40,32          ;columns, rows
   !word $3c00, $6400   ;double buffer bitmap/attr addr
   !word .vdcreg_mode_6
   !byte 80,60          ;columns, rows
   !word 80*32*8, 80*128;interlace bitmap/attr offset
   !word .vdcreg_mode_7
   !byte 100,75         ;columns, rows
   !word 100*38*8, 0    ;interlace bitmap offset
.vdcreg_mode_1:
...
.vdcreg_mode_5:
   ...
   !byte   $01,$28         ;R1 display width=40 cols (320 pix)
   !byte   $02,$37         ;R2 vert sync @ $37 (left edge)
   !byte   $04,$98         ;R4 vert total rows
   !byte   $05,$06         ;R5 vert total adjust
   !byte   $06,$80         ;R6 display height=128 rows
   !byte   $07,$8a         ;R7 vertical sync pos
   !byte   $09,$01         ;R9 scan lines per char -1
   !byte   $16,$89         ;R22 8pix per character
   !byte   $17,$04         ;R23 char vertical size
   !byte   $19,$d7         ;R25(7-4)=%1101 bitmap mode w/ attributes
                           ;  and double-pixel width
   !byte   $0c,$00         ;R12
   !byte   $0d,$00         ;R13 display start=$0000
...
.vdcreg_mode_6:
   ...
   !byte   $04,$80         ;R4 vert total rows (128)
   !byte   $05,$09         ;R5 vert total adjust
   !byte   $06,$80         ;R6 display height=128 rows
   !byte   $07,$78         ;R7 vertical sync pos
   !byte   $08,$03         ;R8 interlace sync+video
   !byte   $09,$03         ;R9 scan lines per char -1
   !byte   $17,$08         ;R23 char vertical size
   !byte   $18,$00         ;R24
   !byte   $19,$c7         ;R25(7-5)=%110 bitmap mode w/ attributes
   !byte   $1b,$00         ;R27 row increment
   ...
   !byte   $0c,$00         ;R12 (even frame)
   !byte   $0d,$00         ;R13 display start=$0000
   !byte   $24,$02         ;R36 vram refresh per scanline
   !byte   255             ;end
.vdcreg_mode_7:
   !byte   $00,$7e         ;R0 total width=126
